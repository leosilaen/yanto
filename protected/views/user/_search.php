<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'username',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>255)))); ?>
				...
				<?php echo $form->dropDownListGroup($model,'level', array('widgetOptions'=>array('data'=>array("Administrator"=>"Administrator","Sekretariat"=>"Sekretariat","Akuntansi"=>"Akuntansi","Perbendaharaan"=>"Perbendaharaan","Kepala Dinas"=>"Kepala Dinas",), 'htmlOptions'=>array('class'=>'input-large')))); ?>
