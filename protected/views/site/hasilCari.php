...
<a href='index.php?r=site/home' class='btn btn-primary btn-flat'>Cari Lagi</a>
<?php 
echo '<section class="content-header">';
$this->menu=array(
array('label'=>'Cetak','url'=>array('print','nomor_berkas'=>$data->nomor_berkas),'buttonType'=> 'link','context' => 'success',),
...
if(sizeof($data)>0)
{
	echo "<h4>Hasil pencarian dokumen dengan nomor <strong>".$data->nomor_berkas."</strong></h4>";
...
{
	?>
	<div class='alert alert-danger'>Tidak ditemukan dokumen dengan nomor berkas <strong><?php echo $nomor_berkas?></strong></div>
	<?php 
}
?>
