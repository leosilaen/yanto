<aside style="min-height: 2104px;" class="left-side sidebar-offcanvas">
		...
		$this->widget('zii.widgets.CMenu',array(
			...
			'items'=>array(
                ...
                array('label'=>'<i class="glyphicon glyphicon-globe"></i> Permohonan Ditandatangani', 'url'=>array('/riwayatAlurBerkas/berkasSelesai'),'visible'=>Yii::app()->user->isSekretariat(),'htmlOptions'=>array('data-toggle'=>'tooltip'),'itemOptions'=>array('data-toggle'=>"tooltip", 'data-placement'=>"right", 'title'=>"Berkas telah ditandatangani oleh Kadis", 'data-content'=>"Default popover",'tabindex'=>"-1")),
                ...
                array('label'=>'<i class="glyphicon glyphicon-list"></i> Berkas Masuk', 'url'=>array('/riwayatAlurBerkas/perbendaharaan'),'visible'=>Yii::app()->user->isPerbendaharaan(),'itemOptions'=>array('data-toggle'=>"tooltip", 'data-placement'=>"right", 'title'=>"Berkas masuk bidang perbendaharaan", 'data-content'=>"Default popover",'tabindex'=>"-1")),
                 array('label'=>'<i class="glyphicon glyphicon-list"></i> Berkas Masuk', 'url'=>array('/riwayatAlurBerkas/kadis'),'visible'=>Yii::app()->user->isKadis(),'itemOptions'=>array('data-toggle'=>"tooltip", 'data-placement'=>"right", 'title'=>"Berkas masuk Kepala DInas", 'data-content'=>"Default popover",'tabindex'=>"-1")),
               ...
               // array('label'=>'<i class="glyphicon glyphicon-list"></i> Verifikasi Akuntansi', 'url'=>array('/tempKonfirmasiHasilPemeriksaan/import'),'visible'=>Yii::app()->user->isAdministrator()),
                ...
                array('label'=>'<i class="glyphicon glyphicon-globe"></i> SKPD', 'url'=>array('/skpd/admin'),'visible'=>Yii::app()->user->isAdministrator()),
