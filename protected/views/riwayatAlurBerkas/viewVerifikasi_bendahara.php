...
array('label'=>'Tolak Permohonan','url'=>array('riwayatProsesDibatalkan/create','id'=>$model->id,'id_berkas'=>$model->id_berkas),'buttonType'=> 'link','context' => 'danger','visible'=>!$model->status_tolak AND !$model->dokumen_belum_tanda_tangan ,'htmlOptions'=>array('id'=>'tolak_permohonan')),
array('label'=>'Terima Permohonan','url'=>array('RiwayatAlurBerkas/terimaVerifikasiBendahara','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'success','visible'=>!$model->dokumen_belum_tanda_tangan and !$model->status_verifikasi),
