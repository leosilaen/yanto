...
array('label'=>'Tanda Tangan Kepala Dinas','url'=>array('RiwayatAlurBerkas/terimaTandaTanganKadis','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'success','visible'=>!$model->status_verifikasi AND !$model->dokumen_tanda_tangan),
array('label'=>'Disposisi','url'=>array('RiwayatAlurBerkas/CreateFromKadis','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'info','visible'=>$model->status_disposisi,'htmlOptions'=>array('id'=>'disposisi')),
