...
<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'enableAjaxValidation'=>false,'action'=>"index.php?r=riwayatAlurBerkas/kadis",'method'=>'get'
...
<a href='index.php?r=riwayatAlurBerkas/kadis' class='btn btn-danger'><i class='glyphicon glyphicon-remove-sign'></i> Clear</a>
</div>
<div class="clear"></div>
<?php $this->endWidget(); ?>
</div>
...
'template'=>'{Terima Disposisi}{Tanda Tangan}{Disposisi}',
'buttons'=>array(
	
	'Tanda Tangan'=>array(
		'icon'=>'glyphicon glyphicon-list-alt',
		'url'=>'Yii::app()->createUrl("riwayatAlurBerkas/TandaTanganKadis", array("id"=>$data->id))',
		'visible'=>'!$data->status_verifikasi AND !$data->dokumen_tanda_tangan',
		'options'=>array(
			'class'=>'button_column',
		)
	),
	'Disposisi'=>array(
		...
		'url'=>'Yii::app()->createUrl("RiwayatAlurBerkas/CreateFromKadis", array("id_berkas"=>$data->id_berkas,"id"=>$data->id))',
	...
	'Terima Disposisi'=>array(
		...
		'url'=>'Yii::app()->createUrl("riwayatAlurBerkas/terimaKadis", array("id"=>$data->id))',
