...
$this->widget(
    ...
    array(
        'links' => array('Data Berkas'=> array('perbendaharaan'),
        'Lihat Data',),		
    )
);
...
array('label'=>'Tolak Permohonan','url'=>array('riwayatProsesDibatalkan/create','id'=>$model->id,'id_berkas'=>$model->id_berkas),'buttonType'=> 'link','context' => 'danger','visible'=>!$model->status_tolak,'htmlOptions'=>array('id'=>'tolak_permohonan')),
array('label'=>'Terima Permohonan','url'=>array('RiwayatAlurBerkas/terimaVerifikasiBendahara','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'success','visible'=>!$model->status_verifikasi),
array('label'=>'Disposisi','url'=>array('RiwayatAlurBerkas/CreateFromBendahara','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'info','visible'=>$model->status_disposisi,'htmlOptions'=>array('id'=>'disposisi')),
...
<br><small>Untuk setiap dokumen masuk urgent, durasi maksimal adalah 2 hari.</small>
</section>
