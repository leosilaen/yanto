...
array('label'=>'Terima Permohonan','url'=>array('RiwayatAlurBerkas/terimaVerifikasiAkuntansi','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'success','visible'=>!$model->status_tolak),
array('label'=>'Disposisi','url'=>array('RiwayatAlurBerkas/CreateFromAkuntansi','id_berkas'=>$model->id_berkas,'id'=>$model->id),'buttonType'=> 'link','context' => 'info','visible'=>$model->status_disposisi,'htmlOptions'=>array('id'=>'disposisi')),
