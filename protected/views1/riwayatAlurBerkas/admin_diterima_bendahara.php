...
<h1>Data Berkas Permohonan diterima Bidang Perbendaharaan</h1>
...
<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'enableAjaxValidation'=>false,'action'=>"index.php?r=riwayatAlurBerkas/diterimaBendahara",'method'=>'get'
...
<a href='index.php?r=riwayatAlurBerkas/diterimaBendahara' class='btn btn-danger'><i class='glyphicon glyphicon-remove-sign'></i> Clear</a>
</div>
<div class="clear"></div>
<?php $this->endWidget(); ?>
</div>
...
'template'=>'{view}{Disposisi}{delete}',
'buttons'=>array(
	'view'=>array(
	...
	'delete'=>array(
		...
		'url'=>'Yii::app()->createUrl("riwayatAlurBerkas/undoTerimaBerkas", array("id"=>$data->id))',
		'options'=>array(
			'class'=>'button_column',
		)
	),
