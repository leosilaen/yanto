 ...
 */
class TbRelationalColumn2 extends TbDataColumn {
	...
	public function renderDataCell($row) {
		...
		//print_r($options['class']);
		echo CHtml::openTag('td', $options);
		echo CHtml::openTag('span', array('id' => $this->name,'class' => $this->cssClass, 'data-rowid' => $this->getPrimaryKey($data)));
	...
	public function registerClientScript() {
		...
		$js = <<<EOD
$(document).on('click','#{$parentId} #{$this->name}', function(){
